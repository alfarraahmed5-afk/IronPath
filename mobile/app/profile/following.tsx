...
export default function FollowingScreen() {
  ...
  useEffect(() => {
    if (!user?.id) return;
    api.get<{ data: { following: FollowingRow[] } }>(`/users/${user.id}/following?limit=50`)
      .then(res => setItems(res.data.following ?? []))
      .catch(() => {})
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              description="Find members on the Leaderboard tab."
            />
          }
