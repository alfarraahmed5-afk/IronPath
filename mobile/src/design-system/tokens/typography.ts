...
// Re-export raw scales from sibling tokens so shadows + radii + spacing
// stay legacy-compatible while typography is the only block we rewrite.
...
export const typography: Record<string, TextStyleLite> = {
  ...
  // Title (Mona Sans). Screen titles, card titles, sub-section.
  ...
  overline:     { fontFamily: 'Barlow_600SemiBold', fontSize: 11, lineHeight: 14, letterSpacing: 1.0, textTransform: 'uppercase' },
  ...
  numericInline: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 14, lineHeight: 20, fontVariant: ['tabular-nums'] },
  numericValue:  { fontFamily: 'MonaSans-Bold',          fontSize: 28, lineHeight: 32, letterSpacing: -0.2, fontVariant: ['tabular-nums'] },
  numericHero:   { fontFamily: 'MonaSans-Bold',          fontSize: 56, lineHeight: 56, letterSpacing: -1.4, fontVariant: ['tabular-nums'] },
...
// `type.numericLarge`; map them onto the new names.
export const type = {
  ...typography,
...
export const typographyAr: Record<string, TextStyleLite> = {
  ...
  overline:     { fontFamily: 'IBMPlexSansArabic-SemiBold', fontSize: 11, lineHeight: 14, letterSpacing: 1.0, textTransform: 'uppercase' },
