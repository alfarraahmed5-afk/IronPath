// /ar/terms -- Arabic terms of service. Mirrors /(legal)/terms with locale
// forced to 'ar'. Modern Standard Arabic for legal context (per the brief).
    ...
    >
      ...
      <p className="text-ink-200 leading-relaxed">
        ...
        <a
          ...
          href="mailto:legal@ironpath.health"
          dir="ltr"
        >
